...
(() => {
  ...
  const HIDE_CSS = `
    ...
    [class*="cookie-banner"]:not(html):not(body), [class*="cookie-consent"]:not(html):not(body),
    [id*="cookie-banner"], [id*="cookie-consent"],
    [class*="CookieBanner"]:not(html):not(body), [class*="CookieConsent"]:not(html):not(body),
    .fc-consent-root, .fc-dialog-overlay, .fc-dialog,
    #qcCmpUi, .qc-cmp2-container,
    ...
    .eupopup-container, #eu-cookie-bar, .eu-cookie-compliance-banner,
